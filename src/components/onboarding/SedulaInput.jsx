...
export default function SedulaInput({ 
  value, 
  onChange, 
  error, 
  isValidating, 
  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="sedula" className="text-white/80">
        Sédula (ID Card) Number
      </Label>
      <div className="relative">
        <Input
          ...
          placeholder="Enter Sédula number"
      ...
      <p className="text-white/40 text-xs">
        Enter your valid Sédula number for identity verification
      </p>
    </div>
  );
}